...
const requiredPaths = [
  ...
  "packages/core/project/watching/project-watch.types.ts",
  "packages/core/project/watching/project-watch-event-normalizer.ts",
  "packages/core/project/watching/project-watch-impact-analyzer.ts",
  "packages/core/project/watching/project-watch-batcher.ts",
  "packages/core/project/cache/project-graph-cache.ts",
  "packages/core/project/refresh/project-graph-refresher.ts",
  "packages/core/project/files/project-file-metadata-reader.ts",
