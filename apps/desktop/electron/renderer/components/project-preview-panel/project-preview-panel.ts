...
function getProjectPreviewPanelElements(panel: HTMLElement): ProjectPreviewPanelElements {
  ...
  return {
    ...
    cssSassInspectorStatus: query("[data-css-sass-inspector-status]", HTMLElement),
    cssSassInspectorMessage: query("[data-css-sass-inspector-message]", HTMLElement),
    cssSassInspectorReadiness: query("[data-css-sass-inspector-readiness]", HTMLDListElement),
    cssSassInspectorSources: query("[data-css-sass-inspector-sources]", HTMLUListElement),
